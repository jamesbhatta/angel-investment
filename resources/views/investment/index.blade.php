...
<div class="bg-light">
    ...
    <div class="container py-5">
        @if(session()->has('invested-successfully'))
        <div>
            <div class="alert alert-success" role="alert">
                <h4 class="alert-heading">Your investment request have been sent successfully.</h4>
        ...
        <div class="card">
            <div class="card-header bg-white py-4">
                <h4 class="h4-responsive">My Investments ({{ $investments->total() }})</h4>
            </div>
            <div class="card-body">

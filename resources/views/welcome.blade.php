...
<section class="ourIndustry">
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">

                    <img class="" src="./img/industry/8.jpg">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">
                    ...
                    <img class="" src="./img/industry/23.jpg">
                    <a href="" title="Software" class="overlay-link">
                        <div class="overlay-link-wrap">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">
                    ...
                    <img class="" src="./img/industry/22.jpg">
                    <a href="" title="Software" class="overlay-link">
                        <div class="overlay-link-wrap">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">
                    ...
                    <img class="" src="./img/industry/16.jpg">
                    <a href="" title="Software" class="overlay-link">
                        <div class="overlay-link-wrap">
                            <span> Property</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">
                    ...
                    <img class="" src="./img/industry/17.jpg">
                    <a href="" title="Software" class="overlay-link">
                        <div class="overlay-link-wrap">
                            <span>Hospitality, Restaurants & Bars </span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 img-show-div mt-4">
                <div class="box-model">
                    ...
                    <img class="" src="./img/industry/19.jpg">
                    <a href="" title="Software" class="overlay-link">
                        <div class="overlay-link-wrap">
                            <span> Retail </span>
                        </div>
        ...
        <div class="text-center">
            ...
            <div class="p-5 view-all js-all-categories-home"><span class="editableLabel" labelid="home_page:view_all_cat">View more industry categories</span></div>
        </div>
    </div>
</section>
<!-- our-industry-end -->

<div class="mb-4">
    ...
    <div class="btn-group d-flex flex-column flex-nowrap my-3" style="overflow-x: auto;">
        ...
        @else
        <a class="{{ $step == 1 ? 'btn-primary' : 'btn-light' }} btn py-3 flex-shrink-0" href="{{ $step > 1 ? route('pitches.create.step-one', ) : '' }}"><i class="far fa-edit"></i><span class="d-md-block d-none">Company Info</span></a>
        <a class="{{ $step == 2 ? 'btn-primary' : 'btn-light' }} btn py-3 flex-shrink-0" href="{{ $step > 2 ? route('pitches.create.step-one', ) : '' }}"><i class="fas fa-desktop"></i><span class="d-md-block d-none">Pitch & Deal</span></a>
